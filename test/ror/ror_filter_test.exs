defmodule RorFilterTest do
  ...
  describe "to_ror_param/1" do
    ...
    test "Converts Filter struct to a ROR filter string" do
      ...
      assert "status:active,types:funder,locations.geonames_details.country_code:DE,locations.geonames_details.country_name:Germany" = Filter.to_ror_param(filter)
